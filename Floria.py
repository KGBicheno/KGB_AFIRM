...
async def nasa_apod(ctx):
	...
	year = str(random.randint(1996, 2021))
	print(year)
	...
	embed = discord.Embed(title=data["title"], url='https://i.imgur.com/Rac5kRM.png',
	                      description=data.get("description"), color=0xffffff)
...
async def nasa_mars(ctx):
	...
	description = "Rover: Curiosity \n Sol {} \n Earth date: {} \n Two photos recieved, left-hand & right-hand forward hazard cameras.".format(
		sol, earth_date)
...
async def no_borders(ctx):
	...
	payload = {}
	headers = {'': 'vslTyZgoWJ4ZfjZpzFJhADiwGc32huIanV9KZSEn', 'Cookie': 'XSRF-TOKEN=; laravel_session=%3D%3D'
}
...
async def support_line(ctx):
	...
	embed = discord.Embed(title="Suicide Call Back Service", url="https://www.suicidecallbackservice.org.au/",
	                      description="Suicide Call Back Service provides 24/7 support if you or someone you know is feeling suicidal.",
	                      color=0xffffff)
	embed.set_author(name="Mental Health Help Line", url="https://www.suicidecallbackservice.org.au/",
	                 icon_url="https://i.imgur.com/xfocDnV.png")
	...
	embed9 = discord.Embed(title="QLife", url="https://qlife.org.au/",
	                       description="QLife provides nationwide telephone and web-based services to support lesbian, gay, bisexual, transgender and intersex (LGBTI) people of all ages.",
	                       color=0xffffff)
	embed9.set_author(name="Mental Health Help Line", url="https://qlife.org.au/",
	                  icon_url="https://i.imgur.com/huk43uW.png")
	...
	embed3 = discord.Embed(title="Butterfly Foundation's National Helpline",
	                       url="https://thebutterflyfoundation.org.au/our-services/helpline/over-the-phone/",
	                       description="ED HOPE, is a free, confidential service that provides information, counselling and treatment referral for people with eating disorders, and body image and related issues.",
	                       color=0xffffff)
	embed3.set_author(name="Mental Health Help Line",
	                  url="https://thebutterflyfoundation.org.au/our-services/helpline/over-the-phone/",
	                  icon_url="https://i.imgur.com/BYzgxVa.png")
	...
	embed4 = discord.Embed(title="eheadspace", url="https://headspace.org.au/eheadspace/",
	                       description="eheadspace provides mental health and wellbeing support, information and services to young people aged 12 to 25 years and their families.",
	                       color=0xffffff)
	embed4.set_author(name="Mental Health Help Line", url="https://headspace.org.au/eheadspace/",
	                  icon_url="https://i.imgur.com/NT1YKMc.png")
	...
	embed5 = discord.Embed(title="Kids Help Line", url="https://kidshelpline.com.au/",
	                       description="Kids Helpline is Australiaâ€™s only free 24/7 confidential and private counseling service specifically for children and young people aged 5 to 25.",
	                       color=0xffffff)
	embed5.set_author(name="Mental Health Help Line", url="https://kidshelpline.com.au/",
	                  icon_url="https://i.imgur.com/mnvvDRQ.png")
	...
	embed6 = discord.Embed(title="Lifeline", url="https://www.lifeline.org.au/",
	                       description="Lifeline provides 24-hour crisis counselling, support groups and suicide prevention services.",
	                       color=0xffffff)
	embed6.set_author(name="Mental Health Help Line", url="https://www.lifeline.org.au/",
	                  icon_url="https://i.imgur.com/84dYdDv.png")
	...
	embed7 = discord.Embed(title="MensLine Australia", url="https://mensline.org.au/",
	                       description="MensLine Australia is a professional telephone and online support and information service for Australian men.",
	                       color=0xffffff)
	embed7.set_author(name="Mental Health Help Line", url="https://mensline.org.au/",
	                  icon_url="https://i.imgur.com/ldayfoE.png")
	...
	embed8 = discord.Embed(title="MindSpot", url="https://mindspot.org.au/",
	                       description="MindSpot is a free telephone and online service for people with stress, worry, anxiety, low mood or depression. It provides online assessment and treatment for anxiety and depression. MindSpot is not an emergency or instant response service.",
	                       color=0xffffff)
	embed8.set_author(name="Mental Health Help Line", url="https://mindspot.org.au/",
	                  icon_url="https://i.imgur.com/G8Cz800.png")
...
async def promote_release(ctx):
	...
	embed = discord.Embed(title="KGB AFIRM [F1AM] Floria V1.3.2 Release Notes",
	                      ...
	                      description="""I've added a number of esteem invocations and increased the number of admin
	                                  ...
	                                  so if you know someone who can give her a go, please ask. I'm willing to add 
	                                  new features on request if it means we get her onto 100 servers by September 
	                                  5th, so email me at kgbicheno@standardmedia.tech or see the links below for 
	                                  more information.
	                                  """,
	                      color=0x00ff00)
	...
	embed.add_field(name="The latest release note and user guide is available here:",
	                value="https://github.com/KGBicheno/KGB_AFIRM/releases",
	                inline=False)
	embed.add_field(name="Found a bug or know something you wish Floria could do? Submit a ticket here:",
	                value="https://github.com/KGBicheno/KGB_AFIRM/issues/new/choose",
	                inline=False)
	embed.add_field(name="Commission your own bot",
	                value="https://github.com/KGBicheno/KGB_AFIRM/issues/new?template=commission.md/",
	                inline=False)
...
async def guild_spread(ctx):
	"""Compile a list of servers in which Floria has a presence."""
	await ctx.author.create_dm()
	await ctx.author.send(
		"I believe you were looking for this, yes? It's a list of all the guilds who've enlisted my talents.")
	coverage = bot.guilds
...
async def maint_list(ctx):
	"""Compile a list of servers and channels in which Floria has a presence."""
	broadcast = []
	patch = bot.guilds
	for server in patch:
	...
	await ctx.send(
		"I've made a list of the places my voice can be heard. Their numerals can be used to connect with those who dwell there.")
...
# TODO maint_mode() Implement Maint_mode to signal to servers or their owners that Floria will be entering
#  maintenance mode and going offline

@bot.command(name="maint_mode", hidden=True)
@commands.has_guild_permissions(administrator=True)
async def count_down(ctx):
	"""Alert subscribed channels that Floria will be going down for maintenance in 5 minutes."""
	channel_list = bot.guilds
	for code in channel_list:
		channel = bot.get_channel(code)
		await bot.channel.send(
			"Hi everyone, I'll be disappearing in 5 minutes' time for regeneration.\n\n If I'll be needed in the next hour, please use f.delay_maint (eg. f.delay_maint I'm on the phone to someone who needs the mental health help line numbers.) \n\n If the reason given is sufficient, my downtime will be delayed.")
...
@bot.command(name="prior_warning", hidden=True)
@commands.has_guild_permissions(administrator=True)
async def prior_warning(ctx):
	"""Alert subscribed channels that Floria will be going down for maintenance at a certain time."""
	channel_list = bot.guilds
	for code in channel_list:
		channel = bot.get_channel(code)
...
async def delay_maint(ctx, *, arg):
	"""Allow a user to petition for the delay of a scheduled or alerted maintenance period."""
...
async def sleep_now(ctx):
	"""If the botbuilder needs me to return to Golem, he can recall me with this invocation."""
	user = bot.get_user(107221097174319104)
	...
	if response.content == CLOSE_PASSKEY:
		...
		await user.send("Sorry, that's not the correct invocation.")
